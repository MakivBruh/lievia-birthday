...
const BirthdayVerse: React.FC = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center text-center space-y-5 p-8"
    >
      {/* Ikon lilin */}
      <motion.svg
      ...
      {/* Garis separator */}
      <div className="w-40 h-[2px] bg-gradient-to-r from-transparent via-white to-transparent opacity-70"></div>

      {/* Ayat */}
      <blockquote className="text-lg italic select-none text-white/90 max-w-xl leading-relaxed drop-shadow-md">
        “Umur panjang ada di tangan kanannya, di tangan kirinya kekayaan dan kehormatan.”
      </blockquote>
      <p className="font-semibold select-none text-white/90">- Amsal 3:16 -</p>
    </motion.div>
  );
};

export default BirthdayVerse;
